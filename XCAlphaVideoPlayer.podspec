...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/guoshuai.cheng@holla.world/XCAlphaVideoPlayer'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'guoshuai.cheng@holla.world' => 'guoshuai.cheng@holla.world' }
  s.source           = { :git => 'https://github.com/guoshuai.cheng@holla.world/XCAlphaVideoPlayer.git', :tag => s.version.to_s }
